...
var _CallumJHays$elm_unwrap$Unwrap$result = function (resultA) {
	var _p0 = resultA;
	if (_p0.ctor === 'Ok') {
		return _p0._0;
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Unwrap',
			{
				...
				end: {line: 42, column: 82}
			},
			_p0)(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'Could not unwrap result. Error: ',
				_elm_lang$core$Basics$toString(_p0._0)));
	}
};
var _CallumJHays$elm_unwrap$Unwrap$maybe = function (maybeA) {
	var _p2 = maybeA;
	if (_p2.ctor === 'Just') {
		return _p2._0;
	} else {
...
var _ambuc$juggling_graph$Types$WH = F2(
	function (a, b) {
		return {w: a, h: b};
	});
var _ambuc$juggling_graph$Types$XY = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _ambuc$juggling_graph$Types$LinearOpts = F5(
	function (a, b, c, d, e) {
		return {unit: a, self_arrow: b, arrow_offset: c, text_offset: d, y_delt: e};
	});
var _ambuc$juggling_graph$Types$CircularOpts = F5(
	function (a, b, c, d, e) {
		return {radius: a, unit: b, self_arrow: c, center: d, multiplex_offset: e};
	});
var _ambuc$juggling_graph$Types$Opts = F5(
	function (a, b, c, d, e) {
		return {num_tokens: a, canvas: b, view: c, viewbox_offset: d, view_opts: e};
	});
var _ambuc$juggling_graph$Types$Throw = F6(
	function (a, b, c, d, e, f) {
		return {value: a, hand: b, is_cross: c, is_valid: d, is_sink: e, $char: f};
	});
var _ambuc$juggling_graph$Types$Beat = F2(
	function (a, b) {
		return {is_valid: a, $throws: b};
	});
var _ambuc$juggling_graph$Types$Token = F5(
	function (a, b, c, d, e) {
		return {txt: a, $throw: b, is_valid: c, catch_index: d, is_catch: e};
	});
var _ambuc$juggling_graph$Types$ParseObject = F4(
	function (a, b, c, d) {
		return {beatmap: a, is_sync: b, tokens: c, is_valid: d};
	});
var _ambuc$juggling_graph$Types$Arrow = F4(
	function (a, b, c, d) {
		return {out_index: a, in_index: b, should_curtail_linear: c, should_curtail_circular: d};
	});
var _ambuc$juggling_graph$Types$Circular = {ctor: 'Circular'};
var _ambuc$juggling_graph$Types$Linear = {ctor: 'Linear'};
var _ambuc$juggling_graph$Types$Center = {ctor: 'Center'};
var _ambuc$juggling_graph$Types$RightHand = {ctor: 'RightHand'};
var _ambuc$juggling_graph$Types$LeftHand = {ctor: 'LeftHand'};
var _ambuc$juggling_graph$Types$Below = {ctor: 'Below'};
var _ambuc$juggling_graph$Types$Above = {ctor: 'Above'};
...
var _ambuc$juggling_graph$Arrow$is_self = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Native_Utils.eq(_p1.out_index, _p1.in_index);
};
var _ambuc$juggling_graph$Arrow$bias = function (_p2) {
	var _p3 = _p2;
	return A2(
		_rogeriochaves$elm_ternary$Ternary_ops['?'],
		_elm_lang$core$Native_Utils.cmp(_p3.out_index, _p3.in_index) < 1,
		_ambuc$juggling_graph$Types$Above)(_ambuc$juggling_graph$Types$Below);
};
...
var _ambuc$juggling_graph$Arrow$mkArrow = F4(
	function (out_index, _p5, _p4, catch_points) {
		...
		var _p7 = _p4;
		var _p9 = _p7.value;
		var jump_distance = _p7.is_cross ? (_p9 + function () {
			var _p8 = _p7.hand;
			switch (_p8.ctor) {
				case 'Center':
					return 0;
		...
		var out_idx_in_catch = _CallumJHays$elm_unwrap$Unwrap$maybe(
			A2(
				...
				catch_points));
		var in_idx_in_catch = A2(
			_elm_lang$core$Basics_ops['%'],
			out_idx_in_catch + jump_distance,
			_elm_lang$core$List$length(catch_points));
		return _elm_lang$core$Native_Utils.update(
			_ambuc$juggling_graph$Arrow$emptyArrow,
			{
				out_index: out_index,
				in_index: _CallumJHays$elm_unwrap$Unwrap$maybe(
					A2(_elm_community$list_extra$List_Extra$getAt, in_idx_in_catch, catch_points))
			});
	});
var _ambuc$juggling_graph$Arrow$mkArrows = function (tokens) {
	var catch_points = _elm_community$list_extra$List_Extra$unique(
		A2(
			_elm_lang$core$List$map,
			function (_) {
				return _.catch_index;
			},
			A2(
				_elm_lang$core$List$filter,
				function (_) {
				...
				_elm_lang$core$List$concat(
					A2(
						...
						function (_p10) {
							...
							if (_p12.ctor === 'Just') {
								var _p13 = _p12._0;
								return _p13.is_sink ? {ctor: '[]'} : {
									ctor: '::',
									_0: A4(_ambuc$juggling_graph$Arrow$mkArrow, _p11._0, _p14, _p13, catch_points),
									_1: {ctor: '[]'}
								};
							} else {
								return {ctor: '[]'};
...
var _ambuc$juggling_graph$Points$flipX = function (a) {
	return {x: -1 * a.x, y: a.y};
};
var _ambuc$juggling_graph$Points$flipY = function (a) {
	return {x: a.x, y: -1 * a.y};
};
var _ambuc$juggling_graph$Points_ops = _ambuc$juggling_graph$Points_ops || {};
_ambuc$juggling_graph$Points_ops['+/+'] = F2(
	function (a, _p0) {
		var _p1 = _p0;
		var _p3 = _p1._0;
		var _p2 = _p1._1;
		return {
			x: a.x + (_p2 * _elm_lang$core$Basics$sin(_p3)),
			y: a.y - (_p2 * _elm_lang$core$Basics$cos(_p3))
		};
	});
var _ambuc$juggling_graph$Points_ops = _ambuc$juggling_graph$Points_ops || {};
_ambuc$juggling_graph$Points_ops['-.-'] = F2(
...
var _ambuc$juggling_graph$Draw$indexedTokenToSvgLinear = F3(
	function (_p2, _p1, _p0) {
		...
		return A2(
			_elm_lang$svg$Svg$text_,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$x(
					_elm_lang$core$Basics$toString(
						_p6.x + (_p7.w * _elm_lang$core$Basics$toFloat(_p5._0)))),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$y(
						_elm_lang$core$Basics$toString(_p6.y + (_p4.canvas.w / 2.0))),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: _elm_lang$svg$Svg_Attributes$fill(
								A2(_rogeriochaves$elm_ternary$Ternary_ops['?'], _p5._1.is_valid, 'black')('red')),
							_1: {
								ctor: '::',
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg$text(_p5._1.txt),
				_1: {ctor: '[]'}
			});
	});
var _ambuc$juggling_graph$Draw$boundToMultiplexBoxLinear = F4(
	function (_p9, _p8, l_idx, r_idx) {
		var _p10 = _p9;
		var _p12 = _p10.unit;
		var _p11 = _p8;
		return A2(
			_elm_lang$svg$Svg$rect,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$x(
					_elm_lang$core$Basics$toString(
						_elm_lang$core$Basics$toFloat(l_idx) * _p12.w)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$y(
						_elm_lang$core$Basics$toString((_p11.canvas.w / 2.0) - (_p12.h / 2.0))),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$width(
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Basics$toFloat(r_idx - l_idx) * _p12.w)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$height(
								_elm_lang$core$Basics$toString(_p12.h)),
							_1: {
								ctor: '::',
	...
	_elm_lang$svg$Svg$marker,
	{
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$refX('7'),
					_1: {
						ctor: '::',
...
var _ambuc$juggling_graph$Draw$mkViewbox = function (_p13) {
	var _p14 = _p13;
	var _p16 = _p14.viewbox_offset;
	var _p15 = _p14.canvas;
	return _elm_lang$svg$Svg_Attributes$viewBox(
		A2(
			...
			A2(
							...
							A2(
								...
								A2(
									...
									A2(
										...
										A2(
											_lukewestby$elm_template$Template_Infix_ops['<%'],
											_lukewestby$elm_template$Template$template(''),
											function (_) {
												return _.min_x;
											}),
										' '),
				...
				''),
			{
				min_x: _elm_lang$core$Basics$toString(_p16.x),
				min_y: _elm_lang$core$Basics$toString(_p16.y),
				width: _elm_lang$core$Basics$toString(_p15.w),
				height: _elm_lang$core$Basics$toString(_p15.h)
			}));
};
var _ambuc$juggling_graph$Draw$curvedRectangle = F7(
	function (o_a, i_a, i_b, o_b, o_r, i_r, angle) {
		return A2(
			_lukewestby$elm_template$Template$render,
			A2(
				_lukewestby$elm_template$Template_Infix_ops['%>'],
				...
				' Z'),
			{
				o_a_x: _elm_lang$core$Basics$toString(o_a.x),
				o_a_y: _elm_lang$core$Basics$toString(o_a.y),
				i_a_x: _elm_lang$core$Basics$toString(i_a.x),
				i_a_y: _elm_lang$core$Basics$toString(i_a.y),
				i_b_x: _elm_lang$core$Basics$toString(i_b.x),
				i_b_y: _elm_lang$core$Basics$toString(i_b.y),
				o_b_x: _elm_lang$core$Basics$toString(o_b.x),
				o_b_y: _elm_lang$core$Basics$toString(o_b.y),
				i_r: _elm_lang$core$Basics$toString(i_r),
				o_r: _elm_lang$core$Basics$toString(o_r),
				large_arc_i: _elm_lang$core$Basics$toString(
					A2(
						_rogeriochaves$elm_ternary$Ternary_ops['?'],
						_elm_lang$core$Native_Utils.cmp(angle, _elm_lang$core$Basics$pi) < 0,
						0)(1)),
				large_arc_o: _elm_lang$core$Basics$toString(
					A2(
						_rogeriochaves$elm_ternary$Ternary_ops['?'],
						_elm_lang$core$Native_Utils.cmp(angle, _elm_lang$core$Basics$pi) < 0,
						0)(1))
...
var _ambuc$juggling_graph$Draw$rotateAbout = F2(
	function (t, c) {
		return A2(
			_lukewestby$elm_template$Template$render,
			A2(
				...
				')'),
			{
				t: _elm_lang$core$Basics$toString(t),
				c_x: _elm_lang$core$Basics$toString(c.x),
				c_y: _elm_lang$core$Basics$toString(c.y)
			});
	});
var _ambuc$juggling_graph$Draw$indexedTokenToSvgCircular = F3(
	function (_p19, _p18, _p17) {
		var _p20 = _p19;
		var _p23 = _p20.center;
		var _p21 = _p18;
		var _p22 = _p17;
		return A2(
			_elm_lang$svg$Svg$text_,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$y(
						_elm_lang$core$Basics$toString(_p23.y - _p20.radius)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$fontSize(
							_elm_lang$core$Basics$toString(_p20.unit.h)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$fill(
								A2(_rogeriochaves$elm_ternary$Ternary_ops['?'], _p22._1.is_valid, 'black')('red')),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$textAnchor('middle'),
								_1: {
									...
									_0: _elm_lang$svg$Svg_Attributes$transform(
										A2(
											_ambuc$juggling_graph$Draw$rotateAbout,
											(360.0 / _elm_lang$core$Basics$toFloat(_p21.num_tokens)) * _elm_lang$core$Basics$toFloat(_p22._0),
											_p23)),
									_1: {ctor: '[]'}
								}
							}
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg$text(_p22._1.txt),
				_1: {ctor: '[]'}
			});
	});
	...
	function (opts, _p24) {
		...
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				function () {
					var _p26 = opts.view_opts;
					if (_p26.ctor === 'Left') {
						return A2(_ambuc$juggling_graph$Draw$indexedTokenToSvgLinear, _p26._0, opts);
					} else {
						return A2(_ambuc$juggling_graph$Draw$indexedTokenToSvgCircular, _p26._0, opts);
					}
				}(),
				A2(
					_elm_lang$core$List$indexedMap,
...
var _ambuc$juggling_graph$Draw$arcString = F6(
	function (pt_i, radius, x_axis_rotation, large_arc, sweep, pt_f) {
		return A2(
			_lukewestby$elm_template$Template$render,
			A2(
				_lukewestby$elm_template$Template_Infix_ops['%>'],
				...
				''),
			{
				pt_i_x: _elm_lang$core$Basics$toString(pt_i.x),
				pt_i_y: _elm_lang$core$Basics$toString(pt_i.y),
				radius: _elm_lang$core$Basics$toString(radius),
				sweepf: _elm_lang$core$Basics$toString(
					A2(_rogeriochaves$elm_ternary$Ternary_ops['?'], sweep, 1)(0)),
				largef: _elm_lang$core$Basics$toString(
					A2(_rogeriochaves$elm_ternary$Ternary_ops['?'], large_arc, 1)(0)),
				xaxisf: _elm_lang$core$Basics$toString(
					A2(_rogeriochaves$elm_ternary$Ternary_ops['?'], x_axis_rotation, 1)(0)),
				pt_f_x: _elm_lang$core$Basics$toString(pt_f.x),
				pt_f_y: _elm_lang$core$Basics$toString(pt_f.y)
			});
	});
var _ambuc$juggling_graph$Draw$mkThrowLinear = F3(
	function (_p28, _p27, arr) {
		var _p29 = _p28;
		var _p33 = _p29.canvas;
		var _p30 = _p27;
		var _p32 = _p30.y_delt;
		var _p31 = _p30.unit;
		var base = {
			x: 0,
			y: _elm_lang$core$Native_Utils.eq(
				_ambuc$juggling_graph$Arrow$bias(arr),
				_ambuc$juggling_graph$Types$Above) ? ((_p33.w / 2.0) - _p31.h) : ((_p33.w / 2.0) + _p30.arrow_offset.y)
		};
		var in_coord = function (arr) {
			return _elm_lang$core$Basics$toFloat(arr.in_index) * _p31.w;
		};
		var $final = {
			x: in_coord(arr),
			y: base.y
		...
		var out_coord = function (arr) {
			return _elm_lang$core$Basics$toFloat(arr.out_index) * _p31.w;
		};
		var radius = _elm_lang$core$Basics$abs(
			(out_coord(arr) - in_coord(arr)) / 2.0);
		var curtailed_final = function () {
			var dy = _elm_lang$core$Basics$sqrt(
				Math.pow(radius, 2) - Math.pow(_p32, 2));
			var dx = (out_coord(arr) + in_coord(arr)) / 2.0;
			return _elm_lang$core$Native_Utils.eq(
				_ambuc$juggling_graph$Arrow$bias(arr),
				_ambuc$juggling_graph$Types$Above) ? {x: dx + dy, y: base.y - _p32} : {x: dx - dy, y: base.y + _p32};
		}();
		var pt_f = A2(_rogeriochaves$elm_ternary$Ternary_ops['?'], arr.should_curtail_linear, curtailed_final)($final);
		var pt_i = {
			x: out_coord(arr),
			y: base.y
		};
		return A6(_ambuc$juggling_graph$Draw$arcString, pt_i, radius, false, false, true, pt_f);
	});
var _ambuc$juggling_graph$Draw$curveString = F4(
	function (pt_0, pt_1, pt_2, pt_3) {
		return A2(
			_lukewestby$elm_template$Template$render,
			A2(
				_lukewestby$elm_template$Template_Infix_ops['%>'],
				...
				''),
			{
				pt_0_x: _elm_lang$core$Basics$toString(pt_0.x),
				pt_0_y: _elm_lang$core$Basics$toString(pt_0.y),
				pt_1_x: _elm_lang$core$Basics$toString(pt_1.x),
				pt_1_y: _elm_lang$core$Basics$toString(pt_1.y),
				pt_2_x: _elm_lang$core$Basics$toString(pt_2.x),
				pt_2_y: _elm_lang$core$Basics$toString(pt_2.y),
				pt_3_x: _elm_lang$core$Basics$toString(pt_3.x),
				pt_3_y: _elm_lang$core$Basics$toString(pt_3.y)
			});
	});
var _ambuc$juggling_graph$Draw$mkLoopLinear = F3(
	function (_p35, _p34, arr) {
		var _p36 = _p35;
		var _p37 = _p34;
		var _p39 = _p37.unit;
		var _p38 = _p37.self_arrow;
		var out_coord = function (arr) {
			return _elm_lang$core$Basics$toFloat(arr.out_index) * _p39.w;
		};
		var base = {
			x: out_coord(arr),
			y: (_p36.canvas.w / 2.0) - _p39.h
		};
		return A4(
			_ambuc$juggling_graph$Draw$curveString,
			base,
			A2(_ambuc$juggling_graph$Points_ops['-.-'], base, _p38),
			A2(
				_ambuc$juggling_graph$Points_ops['+.+'],
				base,
				_ambuc$juggling_graph$Points$flipY(_p38)),
			base);
	});
var _ambuc$juggling_graph$Draw$arrowToSvgLinear = F3(
	function (linear_opts, opts, arr) {
		return A2(
			_elm_lang$svg$Svg$path,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$d(
					A3(
						A2(
							...
							_ambuc$juggling_graph$Draw$mkLoopLinear)(_ambuc$juggling_graph$Draw$mkThrowLinear),
						opts,
						linear_opts,
						arr)),
				_1: {
...
var _ambuc$juggling_graph$Draw$mkLoopCircular = F3(
	function (_p42, _p41, _p40) {
		var _p43 = _p42;
		var _p44 = _p41;
		var _p47 = _p44.self_arrow;
		var _p46 = _p44.center;
		var _p45 = _p40;
		var pt_0 = {x: _p46.x, y: (_p46.y - _p44.radius) + (_p44.unit.h / 2)};
		return A4(
			_ambuc$juggling_graph$Draw$curveString,
			pt_0,
			A2(
				_ambuc$juggling_graph$Points_ops['+.+'],
				pt_0,
				_ambuc$juggling_graph$Points$flipX(_p47)),
			A2(_ambuc$juggling_graph$Points_ops['+.+'], pt_0, _p47),
			pt_0);
	});
var _ambuc$juggling_graph$Draw$dist = F2(
	function (a, b) {
		return _elm_lang$core$Basics$sqrt(
			Math.pow(b.x - a.x, 2) + Math.pow(b.y - a.y, 2));
	});
var _ambuc$juggling_graph$Draw$closest_to = F3(
	function (o, a, b) {
		return A2(
			_rogeriochaves$elm_ternary$Ternary_ops['?'],
			_elm_lang$core$Native_Utils.cmp(
				A2(_ambuc$juggling_graph$Draw$dist, b, o),
				A2(_ambuc$juggling_graph$Draw$dist, a, o)) > 0,
			a)(b);
	});
var _ambuc$juggling_graph$Draw$furthest_from = F3(
	function (o, a, b) {
		return A2(
			_rogeriochaves$elm_ternary$Ternary_ops['?'],
			_elm_lang$core$Native_Utils.cmp(
...
var _ambuc$juggling_graph$Draw$sign_of_cross = F3(
	function (o, a, b) {
		return ((a.x - o.x) * (b.y - o.y)) - ((a.y - o.y) * (b.x - o.x));
	});
var _ambuc$juggling_graph$Draw$midpoint = F2(
	function (a, b) {
		return {x: (a.x + b.x) / 2.0, y: (a.y + b.y) / 2.0};
	});
var _ambuc$juggling_graph$Draw$slope = F2(
	function (a, b) {
		return A2(_elm_lang$core$Basics$atan2, b.y - a.y, b.x - a.x);
	});
var _ambuc$juggling_graph$Draw$tau = 2 * _elm_lang$core$Basics$pi;
var _ambuc$juggling_graph$Draw$mkThrowCircular = F3(
	function (_p49, _p48, arr) {
		var _p50 = _p49;
		var _p55 = _p50.num_tokens;
		var _p51 = _p48;
		var _p54 = _p51.unit;
		var _p53 = _p51.radius;
		var _p52 = _p51.center;
		var r_b = 15.0;
		var b = A2(
			_ambuc$juggling_graph$Points_ops['+/+'],
			_p52,
			{
				ctor: '_Tuple2',
				_0: (_ambuc$juggling_graph$Draw$tau / _elm_lang$core$Basics$toFloat(_p55)) * _elm_lang$core$Basics$toFloat(arr.in_index),
				_1: _p53 - (_p54.h / 2)
			});
		var a = A2(
			_ambuc$juggling_graph$Points_ops['+/+'],
			...
			{
				ctor: '_Tuple2',
				_0: (_ambuc$juggling_graph$Draw$tau / _elm_lang$core$Basics$toFloat(_p55)) * _elm_lang$core$Basics$toFloat(arr.out_index),
				_1: _p53 - (_p54.h / 2)
			});
		var r_c = A2(_ambuc$juggling_graph$Draw$dist, a, b) / 1.25;
		var rp_c = _elm_lang$core$Basics$sqrt(
			Math.pow(r_c, 2) - Math.pow(
				A2(_ambuc$juggling_graph$Draw$dist, a, b) / 2.0,
				2));
		var c = A3(
			_ambuc$juggling_graph$Draw$furthest_from,
			_p52,
			A2(
				_ambuc$juggling_graph$Points_ops['+/+'],
				A2(_ambuc$juggling_graph$Draw$midpoint, a, b),
				{
					ctor: '_Tuple2',
					_0: A2(_ambuc$juggling_graph$Draw$slope, a, b),
					_1: rp_c
				}),
			A2(
				_ambuc$juggling_graph$Points_ops['+/+'],
		...
		var bp = function () {
			var theta = _elm_lang$core$Basics$acos(
				((2 * Math.pow(r_c, 2)) - Math.pow(r_b, 2)) / (2 * Math.pow(r_c, 2)));
			return A3(
				_ambuc$juggling_graph$Draw$closest_to,
				_p52,
				A2(
					_ambuc$juggling_graph$Points_ops['+/+'],
					c,
					{
						ctor: '_Tuple2',
						_0: ((_elm_lang$core$Basics$pi / 2) + A2(_ambuc$juggling_graph$Draw$slope, c, b)) + theta,
						_1: r_c
					}),
				A2(
					_ambuc$juggling_graph$Points_ops['+/+'],
		...
		var e = A2(_rogeriochaves$elm_ternary$Ternary_ops['?'], arr.should_curtail_circular, bp)(b);
		var sweep_in = arr.should_curtail_circular ? (_elm_lang$core$Native_Utils.cmp(
			A3(_ambuc$juggling_graph$Draw$sign_of_cross, a, b, c),
			0) > 0) : (_elm_lang$core$Native_Utils.cmp(
			A3(_ambuc$juggling_graph$Draw$sign_of_cross, a, b, _p52),
			0) < 0);
		return A6(_ambuc$juggling_graph$Draw$arcString, a, r_c, false, false, sweep_in, e);
	});
var _ambuc$juggling_graph$Draw$arrowToSvgCircular = F3(
	function (circular_opts, opts, arr) {
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
			{
						...
						_0: _elm_lang$svg$Svg_Attributes$d(
							A3(
								A2(
									_rogeriochaves$elm_ternary$Ternary_ops['?'],
									_ambuc$juggling_graph$Arrow$is_self(arr),
									_ambuc$juggling_graph$Draw$mkLoopCircular)(_ambuc$juggling_graph$Draw$mkThrowCircular),
								opts,
								circular_opts,
								arr)),
						_1: {
										...
										_1: {
											...
											_0: _elm_lang$svg$Svg_Attributes$transform(
												_ambuc$juggling_graph$Arrow$is_self(arr) ? A2(
													_ambuc$juggling_graph$Draw$rotateAbout,
													(360.0 / _elm_lang$core$Basics$toFloat(opts.num_tokens)) * _elm_lang$core$Basics$toFloat(arr.out_index),
	...
	function (opts, parseObject) {
		return (!parseObject.is_valid) ? A2(
			...
			A2(
				_elm_lang$core$List$map,
				function () {
					var _p56 = opts.view_opts;
					if (_p56.ctor === 'Left') {
						return A2(_ambuc$juggling_graph$Draw$arrowToSvgLinear, _p56._0, opts);
					} else {
						return A2(_ambuc$juggling_graph$Draw$arrowToSvgCircular, _p56._0, opts);
					}
				}(),
				_ambuc$juggling_graph$Arrow$mkArrows(parseObject.tokens)));
	});
var _ambuc$juggling_graph$Draw$boundsToMultiplexBoxCircular = F4(
	function (_p57, opts, l_idx, r_idx) {
		var _p58 = _p57;
		var _p62 = _p58.unit;
		var _p61 = _p58.radius;
		var _p60 = _p58.multiplex_offset;
		var _p59 = _p58.center;
		var outer_r = (_p61 + (_p62.h / 2.0)) + _p60.y;
		var inner_r = (_p61 - (_p62.h / 2.0)) + _p60.y;
		var l_th = (_ambuc$juggling_graph$Draw$tau / _elm_lang$core$Basics$toFloat(opts.num_tokens)) * _elm_lang$core$Basics$toFloat(l_idx);
		var r_th = (_ambuc$juggling_graph$Draw$tau / _elm_lang$core$Basics$toFloat(opts.num_tokens)) * _elm_lang$core$Basics$toFloat(r_idx);
		return A2(
			_elm_lang$svg$Svg$path,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$d(
					A7(
						_ambuc$juggling_graph$Draw$curvedRectangle,
						A2(
							_ambuc$juggling_graph$Points_ops['+/+'],
							_p59,
							{ctor: '_Tuple2', _0: l_th, _1: outer_r}),
						A2(
							_ambuc$juggling_graph$Points_ops['+/+'],
							_p59,
							{ctor: '_Tuple2', _0: l_th, _1: inner_r}),
						A2(
							_ambuc$juggling_graph$Points_ops['+/+'],
							_p59,
							{ctor: '_Tuple2', _0: r_th, _1: inner_r}),
						A2(
							_ambuc$juggling_graph$Points_ops['+/+'],
							_p59,
							{ctor: '_Tuple2', _0: r_th, _1: outer_r}),
						outer_r,
						inner_r,
						r_th - l_th)),
				_1: {
		...
		return A2(
			...
			A3(
				...
				function () {
					...
					if (_p65.ctor === 'Left') {
						return A2(_ambuc$juggling_graph$Draw$boundToMultiplexBoxLinear, _p65._0, opts);
					} else {
						return A2(_ambuc$juggling_graph$Draw$boundsToMultiplexBoxCircular, _p65._0, opts);
					}
				}(),
				A2(
...
var _ambuc$juggling_graph$Tokens$chr_len = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1.$throws;
	return A2(
		_rogeriochaves$elm_ternary$Ternary_ops['?'],
		_elm_lang$core$Native_Utils.eq(
			...
			1),
		1)(
		2 + _elm_lang$core$List$length(_p2));
};
var _ambuc$juggling_graph$Tokens$emptyToken = {txt: '', $throw: _elm_lang$core$Maybe$Nothing, catch_index: 0, is_catch: false, is_valid: true};
var _ambuc$juggling_graph$Tokens$syntaxToToken = function (x) {
	return _elm_lang$core$Native_Utils.update(
		_ambuc$juggling_graph$Tokens$emptyToken,
		{
			txt: _elm_lang$core$String$fromList(
				{
					ctor: '::',
					_0: x,
					_1: {ctor: '[]'}
...
var _ambuc$juggling_graph$Tokens$throwToToken = F2(
	function (curr_idx, $throw) {
		return _elm_lang$core$Native_Utils.update(
			_ambuc$juggling_graph$Tokens$emptyToken,
			{
				txt: _elm_lang$core$String$fromList(
				...
				$throw: _elm_lang$core$Maybe$Just($throw),
				catch_index: curr_idx,
				is_valid: $throw.is_valid
			});
	});
var _ambuc$juggling_graph$Tokens$beatToToken = F2(
	function (curr_idx, _p3) {
		var _p4 = _p3;
		var _p5 = _p4.$throws;
		var right_bracket = {
			ctor: '::',
			_0: _ambuc$juggling_graph$Tokens$syntaxToToken(
				_elm_lang$core$Native_Utils.chr(']')),
			_1: {ctor: '[]'}
		};
		var inner = A2(
			_elm_lang$core$List$map,
			_ambuc$juggling_graph$Tokens$throwToToken(curr_idx),
			_p5);
		var left_bracket = {
			ctor: '::',
		...
		return _elm_lang$core$Native_Utils.eq(
			...
			inner) : _elm_lang$core$List$concat(
			{
				ctor: '::',
				_0: left_bracket,
				_1: {
...
var _ambuc$juggling_graph$Tokens$beatmapToToken = F2(
	function (curr_idx, beatmap) {
		var _p6 = _elm_community$list_extra$List_Extra$uncons(beatmap);
		_v2_2:
		do {
			if (((_p6.ctor === 'Just') && (_p6._0.ctor === '_Tuple2')) && (_p6._0._0.ctor === '::')) {
				if (_p6._0._0._1.ctor === '[]') {
					var _p7 = _p6._0._0._0;
					return _elm_lang$core$List$concat(
						{
							ctor: '::',
							_0: A2(_ambuc$juggling_graph$Tokens$beatToToken, curr_idx, _p7),
							_1: {
								ctor: '::',
								_0: A2(
									_ambuc$juggling_graph$Tokens$beatmapToToken,
									curr_idx + _ambuc$juggling_graph$Tokens$chr_len(_p7),
									_p6._0._1),
								_1: {ctor: '[]'}
							}
						});
				} else {
					if (_p6._0._0._1._1.ctor === '[]') {
						var _p9 = _p6._0._0._1._0;
						...
						return _elm_lang$core$List$concat(
							{
								...
								_1: {
									ctor: '::',
									_0: A2(_ambuc$juggling_graph$Tokens$beatToToken, curr_idx + 1, _p8),
									_1: {
										ctor: '::',
										_0: {
											ctor: '::',
										...
										_1: {
											ctor: '::',
											_0: A2(
												_ambuc$juggling_graph$Tokens$beatToToken,
												(curr_idx + _ambuc$juggling_graph$Tokens$chr_len(_p8)) + 2,
												_p9),
											_1: {
												ctor: '::',
												_0: {
												...
												_1: {
													...
													_0: A2(
														_ambuc$juggling_graph$Tokens$beatmapToToken,
														((curr_idx + _ambuc$juggling_graph$Tokens$chr_len(_p8)) + _ambuc$juggling_graph$Tokens$chr_len(_p9)) + 3,
														_p6._0._1),
													_1: {ctor: '[]'}
												}
											}
...
var _ambuc$juggling_graph$Tokens$mkTokens = function (beatmap) {
...
var _ambuc$juggling_graph$StateMachine$applyAsterisk = function (llb) {
	var flipHandsOnThrow = function (t) {
		return _elm_lang$core$Native_Utils.eq(t.hand, _ambuc$juggling_graph$Types$RightHand) ? _elm_lang$core$Native_Utils.update(
			t,
			{hand: _ambuc$juggling_graph$Types$LeftHand}) : (_elm_lang$core$Native_Utils.eq(t.hand, _ambuc$juggling_graph$Types$LeftHand) ? _elm_lang$core$Native_Utils.update(
			t,
			{hand: _ambuc$juggling_graph$Types$RightHand}) : t);
	};
...
var _ambuc$juggling_graph$StateMachine$charToInt = function (c) {
	if (_elm_lang$core$Char$isDigit(c)) {
		...
		if (_elm_lang$core$Char$isLower(c)) {
			return _elm_lang$core$Maybe$Just(
				(_elm_lang$core$Char$toCode(c) - 97) + 10);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	}
};
var _ambuc$juggling_graph$StateMachine$markAsCross = function ($throw) {
	return _elm_lang$core$Native_Utils.update(
		$throw,
		{is_cross: true});
};
var _ambuc$juggling_graph$StateMachine$emptyThrow = {
	value: 0,
	is_cross: false,
	is_valid: true,
	is_sink: false,
	$char: _elm_lang$core$Native_Utils.chr(' '),
	hand: _ambuc$juggling_graph$Types$Center
};
var _ambuc$juggling_graph$StateMachine$sinkThrow = _elm_lang$core$Native_Utils.update(
	_ambuc$juggling_graph$StateMachine$emptyThrow,
	{
		$char: _elm_lang$core$Native_Utils.chr('_'),
		is_sink: true
	});
var _ambuc$juggling_graph$StateMachine$invalidThrow = function (chr) {
	return _elm_lang$core$Native_Utils.update(
		_ambuc$juggling_graph$StateMachine$emptyThrow,
		{value: 0, is_valid: false, $char: chr});
};
var _ambuc$juggling_graph$StateMachine$newThrow = F2(
	function (hand, chr) {
		if (_elm_lang$core$Native_Utils.eq(
			chr,
			_elm_lang$core$Native_Utils.chr('_'))) {
			return _ambuc$juggling_graph$StateMachine$sinkThrow;
		} else {
			...
			if (_p2.ctor === 'Just') {
				...
				return _ambuc$juggling_graph$StateMachine$invalidThrow(chr);
			}
		}
	});
	...
	function (hand, chr) {
		return _elm_lang$core$Native_Utils.update(
			_ambuc$juggling_graph$StateMachine$emptyBeat,
			{
				$throws: {
					ctor: '::',
					_0: A2(_ambuc$juggling_graph$StateMachine$newThrow, hand, chr),
					_1: {ctor: '[]'}
				}
			});
	});
...
var _ambuc$juggling_graph$StateMachine$push_ = F2(
	function (hand, x) {
		return A2(
			_elm_community$list_extra$List_Extra$updateAt,
			0,
...
var _ambuc$juggling_graph$StateMachine$invalidBeat = function (chr) {
	return _elm_lang$core$Native_Utils.update(
		_ambuc$juggling_graph$StateMachine$emptyBeat,
		{
			$throws: {
				ctor: '::',
				_0: _ambuc$juggling_graph$StateMachine$invalidThrow(chr),
				_1: {ctor: '[]'}
			},
			is_valid: false
		});
...
var _ambuc$juggling_graph$StateMachine$AS_BRACE = {ctor: 'AS_BRACE'};
var _ambuc$juggling_graph$StateMachine$AS_BRACE_EMPTY = {ctor: 'AS_BRACE_EMPTY'};
var _ambuc$juggling_graph$StateMachine$AS_NORMAL = {ctor: 'AS_NORMAL'};
var _ambuc$juggling_graph$StateMachine$S_PAREN = {ctor: 'S_PAREN'};
var _ambuc$juggling_graph$StateMachine$S_SECOND_X_OR_BRACE = {ctor: 'S_SECOND_X_OR_BRACE'};
var _ambuc$juggling_graph$StateMachine$S_SECOND_BRACE = {ctor: 'S_SECOND_BRACE'};
var _ambuc$juggling_graph$StateMachine$S_SECOND_BRACE_EMPTY = {ctor: 'S_SECOND_BRACE_EMPTY'};
var _ambuc$juggling_graph$StateMachine$S_SECOND_X = {ctor: 'S_SECOND_X'};
var _ambuc$juggling_graph$StateMachine$S_SECOND = {ctor: 'S_SECOND'};
var _ambuc$juggling_graph$StateMachine$S_COMMA = {ctor: 'S_COMMA'};
var _ambuc$juggling_graph$StateMachine$S_FIRST_X = {ctor: 'S_FIRST_X'};
var _ambuc$juggling_graph$StateMachine$S_FIRST_X_OR_BRACE = {ctor: 'S_FIRST_X_OR_BRACE'};
var _ambuc$juggling_graph$StateMachine$S_FIRST_BRACE = {ctor: 'S_FIRST_BRACE'};
			...
			if (!_ambuc$juggling_graph$StateMachine$is_beatmap_valid(_p26)) {
				...
				switch (_p9.ctor) {
					case 'INIT':
						var _p10 = head;
						if (_p10.valueOf() === '(') {
							var _v7 = {ctor: '_Tuple3', _0: _ambuc$juggling_graph$StateMachine$S_NORMAL, _1: _p27, _2: _p26};
							_p4 = _v7;
							continue parse;
						} else {
							var _v8 = {ctor: '_Tuple3', _0: _ambuc$juggling_graph$StateMachine$AS_NORMAL, _1: _p27, _2: _p26};
							_p4 = _v8;
							continue parse;
						}
					case 'AS_NORMAL':
						...
						if (_p11.valueOf() === '[') {
							...
							var _v11 = {
								ctor: '_Tuple3',
								_0: _ambuc$juggling_graph$StateMachine$AS_NORMAL,
								_1: tail,
								_2: {
									ctor: '::',
									_0: {
										ctor: '::',
										_0: A2(_ambuc$juggling_graph$StateMachine$newBeat, _ambuc$juggling_graph$Types$Center, _p11),
										_1: {ctor: '[]'}
									},
									_1: _p26
								}
					...
					case 'AS_BRACE_EMPTY':
						var _v12 = {
							...
							_1: tail,
							_2: A3(_ambuc$juggling_graph$StateMachine$push_, _ambuc$juggling_graph$Types$Center, head, _p26)
						};
						_p4 = _v12;
						continue parse;
					case 'AS_BRACE':
						var _p12 = head;
						if (_p12.valueOf() === ']') {
							var _v14 = {ctor: '_Tuple3', _0: _ambuc$juggling_graph$StateMachine$AS_NORMAL, _1: tail, _2: _p26};
							_p4 = _v14;
							continue parse;
						} else {
							var _v15 = {
					...
					case 'S_NORMAL':
						...
						switch (_p13.valueOf()) {
							case '(':
								...
								continue parse;
							case '*':
								return _ambuc$juggling_graph$StateMachine$applyAsterisk(_p26);
							default:
								return {
									ctor: '::',
									_0: {
					...
					case 'S_FIRST':
						...
						switch (_p14.valueOf()) {
							case '[':
								var _v19 = {ctor: '_Tuple3', _0: _ambuc$juggling_graph$StateMachine$S_FIRST_BRACE_EMPTY, _1: tail, _2: _p26};
								_p4 = _v19;
								continue parse;
							case '0':
								var _v20 = {
									ctor: '_Tuple3',
									_0: _ambuc$juggling_graph$StateMachine$S_COMMA,
									_1: tail,
									_2: A3(
										_ambuc$juggling_graph$StateMachine$push_,
										_ambuc$juggling_graph$Types$LeftHand,
										_elm_lang$core$Native_Utils.chr('0'),
										_p26)
								};
								_p4 = _v20;
							...
							case 'x':
								return {
									...
									_0: {
										ctor: '::',
										_0: _ambuc$juggling_graph$StateMachine$invalidBeat(
							...
							default:
								var _v21 = {
									...
									_1: tail,
									_2: A3(_ambuc$juggling_graph$StateMachine$push_, _ambuc$juggling_graph$Types$LeftHand, _p14, _p26)
								};
								_p4 = _v21;
								continue parse;
						}
					case 'S_FIRST_BRACE_EMPTY':
						...
						switch (_p15.valueOf()) {
							case '0':
								var _v23 = {
									ctor: '_Tuple3',
									_0: _ambuc$juggling_graph$StateMachine$S_FIRST_BRACE,
									_1: tail,
									_2: A3(
										_ambuc$juggling_graph$StateMachine$push_,
										_ambuc$juggling_graph$Types$LeftHand,
							...
							default:
								var _v24 = {
									...
									_1: tail,
									_2: A3(_ambuc$juggling_graph$StateMachine$push_, _ambuc$juggling_graph$Types$LeftHand, head, _p26)
								};
								_p4 = _v24;
								continue parse;
						}
					case 'S_FIRST_BRACE':
						...
						switch (_p16.valueOf()) {
							case '0':
								...
								continue parse;
							case ']':
								var _v27 = {ctor: '_Tuple3', _0: _ambuc$juggling_graph$StateMachine$S_COMMA, _1: tail, _2: _p26};
								_p4 = _v27;
								continue parse;
							case 'x':
								return {
					...
					case 'S_FIRST_X_OR_BRACE':
						...
						switch (_p17.valueOf()) {
							case ']':
								var _v30 = {ctor: '_Tuple3', _0: _ambuc$juggling_graph$StateMachine$S_COMMA, _1: tail, _2: _p26};
								_p4 = _v30;
								continue parse;
							case '0':
								var _v31 = {
					...
					case 'S_FIRST_X':
						...
						switch (_p18.valueOf()) {
							case 'x':
								...
								continue parse;
							case ',':
								var _v36 = {ctor: '_Tuple3', _0: _ambuc$juggling_graph$StateMachine$S_SECOND, _1: tail, _2: _p26};
								_p4 = _v36;
								continue parse;
							default:
								return {
					...
					case 'S_COMMA':
						var _p19 = head;
						if (_p19.valueOf() === ',') {
							var _v38 = {ctor: '_Tuple3', _0: _ambuc$juggling_graph$StateMachine$S_SECOND, _1: tail, _2: _p26};
							_p4 = _v38;
							continue parse;
						} else {
							return {
					...
					case 'S_SECOND':
						...
						switch (_p20.valueOf()) {
							case '0':
								var _v40 = {
									ctor: '_Tuple3',
									_0: _ambuc$juggling_graph$StateMachine$S_PAREN,
									_1: tail,
									_2: A3(
										_elm_community$list_extra$List_Extra$updateAt,
										0,
										function (x) {
											return {
												...
												_0: A2(
													...
													_ambuc$juggling_graph$Types$RightHand,
													_elm_lang$core$Native_Utils.chr('0')),
												_1: x
											};
										},
							...
							case '[':
								var _v41 = {
									ctor: '_Tuple3',
									_0: _ambuc$juggling_graph$StateMachine$S_SECOND_BRACE_EMPTY,
									_1: tail,
									_2: A3(
										_elm_community$list_extra$List_Extra$updateAt,
										0,
							...
							default:
								var _v42 = {
									ctor: '_Tuple3',
									_0: _ambuc$juggling_graph$StateMachine$S_SECOND_X,
									_1: tail,
									_2: A3(
										_elm_community$list_extra$List_Extra$updateAt,
										0,
										function (x) {
											return {
												ctor: '::',
												_0: A2(_ambuc$juggling_graph$StateMachine$newBeat, _ambuc$juggling_graph$Types$RightHand, _p20),
												_1: x
											};
										},
										_p26)
					...
					case 'S_SECOND_X':
						...
						switch (_p21.valueOf()) {
							case ')':
								var _v44 = {ctor: '_Tuple3', _0: _ambuc$juggling_graph$StateMachine$S_NORMAL, _1: tail, _2: _p26};
								_p4 = _v44;
								continue parse;
							case 'x':
								var _v45 = {
					...
					case 'S_SECOND_BRACE_EMPTY':
						...
						switch (_p22.valueOf()) {
							case '0':
								var _v47 = {
									ctor: '_Tuple3',
									_0: _ambuc$juggling_graph$StateMachine$S_SECOND_BRACE,
									_1: tail,
									_2: A3(
										_ambuc$juggling_graph$StateMachine$push_,
										_ambuc$juggling_graph$Types$RightHand,
							...
							default:
								var _v48 = {
									...
									_1: tail,
									_2: A3(_ambuc$juggling_graph$StateMachine$push_, _ambuc$juggling_graph$Types$RightHand, _p22, _p26)
								};
								_p4 = _v48;
								continue parse;
						}
					case 'S_SECOND_BRACE':
						...
						switch (_p23.valueOf()) {
							case '0':
								...
								continue parse;
							case ']':
								var _v51 = {ctor: '_Tuple3', _0: _ambuc$juggling_graph$StateMachine$S_PAREN, _1: tail, _2: _p26};
								_p4 = _v51;
								continue parse;
							case 'x':
								return {
							...
							default:
								var _v52 = {
									...
									_0: _ambuc$juggling_graph$StateMachine$S_SECOND_X_OR_BRACE,
									_1: tail,
									_2: A3(_ambuc$juggling_graph$StateMachine$push_, _ambuc$juggling_graph$Types$RightHand, _p23, _p26)
								};
								_p4 = _v52;
								continue parse;
						}
					case 'S_SECOND_X_OR_BRACE':
						...
						switch (_p24.valueOf()) {
							...
							case 'x':
								...
								continue parse;
							case ']':
								var _v56 = {ctor: '_Tuple3', _0: _ambuc$juggling_graph$StateMachine$S_PAREN, _1: tail, _2: _p26};
								_p4 = _v56;
								continue parse;
							default:
								var _v57 = {
									...
									_0: _ambuc$juggling_graph$StateMachine$S_SECOND_X_OR_BRACE,
									_1: tail,
									_2: A3(_ambuc$juggling_graph$StateMachine$push_, _ambuc$juggling_graph$Types$RightHand, _p24, _p26)
								};
								_p4 = _v57;
								continue parse;
						}
					default:
						var _p25 = head;
						if (_p25.valueOf() === ')') {
							var _v59 = {ctor: '_Tuple3', _0: _ambuc$juggling_graph$StateMachine$S_NORMAL, _1: tail, _2: _p26};
							_p4 = _v59;
							continue parse;
						} else {
							return {
...
var _ambuc$juggling_graph$StateMachine$INIT = {ctor: 'INIT'};
var _ambuc$juggling_graph$StateMachine$parseExpr = function (input_string) {
	var beatmap = A2(
		_elm_lang$core$List$map,
		_elm_lang$core$List$map(
			function (x) {
				return _elm_lang$core$Native_Utils.update(
					x,
					{
						$throws: _elm_lang$core$List$reverse(x.$throws)
					});
			}),
		A2(
			_elm_lang$core$List$map,
			_elm_lang$core$List$reverse,
			_elm_lang$core$List$reverse(
				_ambuc$juggling_graph$StateMachine$parse(
					{
						ctor: '_Tuple3',
						_0: _ambuc$juggling_graph$StateMachine$INIT,
						_1: input_string,
						_2: {ctor: '[]'}
					}))));
	return {
		...
		is_sync: _elm_lang$core$Native_Utils.eq(
			...
			'('),
		tokens: _ambuc$juggling_graph$Tokens$mkTokens(beatmap),
		is_valid: _ambuc$juggling_graph$StateMachine$is_beatmap_valid(beatmap)
	};
};
		...
		return A2(
			_elm_lang$svg$Svg$svg,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$height(
						_elm_lang$core$Basics$toString(opts.canvas.h)),
					_1: {
						ctor: '::',
						_0: _ambuc$juggling_graph$Draw$mkViewbox(opts),
						_1: {ctor: '[]'}
					}
				}
			},
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_ambuc$juggling_graph$Draw$multiplexBoxes, opts, parseObject),
					_1: {
						ctor: '::',
						_0: A2(_ambuc$juggling_graph$Draw$tokenBoxes, opts, parseObject),
						_1: {
							ctor: '::',
							_0: A2(_ambuc$juggling_graph$Draw$arrows, opts, parseObject),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _ambuc$juggling_graph$Main$UpdateExamplesIdx = function (a) {
	return {ctor: 'UpdateExamplesIdx', _0: a};
};
var _ambuc$juggling_graph$Main$Roll = {ctor: 'Roll'};
var _ambuc$juggling_graph$Main$init = {
	ctor: '_Tuple2',
	_0: {expr: '', view: _ambuc$juggling_graph$Types$Circular},
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							view: A2(
								_rogeriochaves$elm_ternary$Ternary_ops['?'],
								_elm_lang$core$Native_Utils.eq(model.view, _ambuc$juggling_graph$Types$Linear),
								_ambuc$juggling_graph$Types$Circular)(_ambuc$juggling_graph$Types$Linear)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Roll':
				return {
					...
					_1: A2(
						_elm_lang$core$Random$generate,
						_ambuc$juggling_graph$Main$UpdateExamplesIdx,
						A2(
							_elm_lang$core$Random$int,
							0,
							_elm_lang$core$List$length(_ambuc$juggling_graph$Examples$examples) - 1))
				};
			default:
				var newExpr = _CallumJHays$elm_unwrap$Unwrap$maybe(
					A2(_elm_community$list_extra$List_Extra$getAt, _p0._0, _ambuc$juggling_graph$Examples$examples));
				return _elm_lang$core$Native_Utils.eq(newExpr, model.expr) ? {
					ctor: '_Tuple2',
					_0: model,
					_1: _GlobalWebIndex$cmd_extra$Cmd_Extra$perform(_ambuc$juggling_graph$Main$Roll)
				} : {
...
var _ambuc$juggling_graph$Main$view = function (model) {
	var output_span = A2(
	...
	var shuffle_span = A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('waves-effect  btn-small red lighten-2'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_ambuc$juggling_graph$Main$Roll),
						_1: {ctor: '[]'}
					}
				},
				{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$for('expr'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Enter a siteswap'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('characterCounter'),
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'type', 'text'),
										_1: {
											ctor: '::',
											_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-length', '30'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$maxlength(30),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(model.expr),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(_ambuc$juggling_graph$Main$Change),
														_1: {ctor: '[]'}
													}
												}
											}
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col s12 m10 offset-m1 l8 offset-l2'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _ambuc$juggling_graph$Main$main = _elm_lang$html$Html$program(
	{
		view: _ambuc$juggling_graph$Main$view,
		update: _ambuc$juggling_graph$Main$update,
		init: _ambuc$juggling_graph$Main$init,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ambuc$juggling_graph$Main$main !== 'undefined') {
    _ambuc$juggling_graph$Main$main(Elm['Main'], 'Main', undefined);
}
